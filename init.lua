...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    event = 'VimEnter', -- Sets the loading event to 'VimEnter' or 'VeryLazy'
    config = function() -- This is the function that runs, AFTER loading
      require('which-key').setup({
        ...
        -- },
        triggers = {
          { "<auto>", mode = "nisotc" }, -- default: "nixsotc" (x: visual mode)
        },
        win = {
          -- height = { max = 10 },
          wo = {
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'lua', 'luadoc', 'markdown', 'vim', 'vimdoc', 'css', 'scss', 'tsx', 'javascript', 'typescript', 'json' },
